 ...
 * 
 */
@WebServiceClient(name = "soapService", targetNamespace = "http://service.ass3.lsde.unitn.it/", wsdlLocation = "http://localhost:5914/ws/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://service.ass3.lsde.unitn.it/", "soapService");
    ...
    public Services getSoapServicesImplPort() {
        return super.getPort(new QName("http://service.ass3.lsde.unitn.it/", "SoapServicesImplPort"), Services.class);
    }
     ...
     */
    @WebEndpoint(name = "SoapServicesImplPort")
    public Services getSoapServicesImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ass3.lsde.unitn.it/", "SoapServicesImplPort"), Services.class, features);
    }
